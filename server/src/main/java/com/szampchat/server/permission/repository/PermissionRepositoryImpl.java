...
public class PermissionRepositoryImpl implements PermissionRepository{
    ...
    @Override
    public Flux<PermissionOverrides> findPermissionsByChannelAndUser(Long channelId, Long userId) {
        ...
        """)
                ...
                .bind("userId", userId)
                .map((row, _) -> new PermissionOverrides(row.get("permission", Long.class)))
                .all();
    }
}
